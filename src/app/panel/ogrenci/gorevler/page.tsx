  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <p className="mt-1 text-sm text-slate-500 dark:text-slate-400">Koçunun sana atadığı görevler.</p>
      </div>

      <Card>
        <CardContent className="pt-5">
          {list.length === 0 ? (
            <p className="text-sm text-slate-500 dark:text-slate-400">Henüz sana atanmış bir görev yok.</p>
          ) : (
